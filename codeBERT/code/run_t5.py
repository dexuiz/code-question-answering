...
from transformers import RobertaConfig, RobertaModel, RobertaTokenizer,T5ForConditionalGeneration,  T5Config
        ...
        for epoch in range(args.num_train_epochs):
            ...
            if args.do_eval:
                ...
                for batch in eval_dataloader:
                    ...
                    with torch.no_grad():
                        preds = model.generate(input_ids=source_ids, attention_mask=source_mask,max_length=args.max_target_length,num_beams=args.beam_size)
                        for pred in preds:
                        #     t=pred[0].cpu().numpy()
                        #     t=list(t)
                        #     if 0 in t:
